<!-- Session Notes: thread-tagged session-to-session narrative — update after every session -->
...
| --- | --- | --- | --- |
| `session-notes.md` (this file) | [N] | ~2,000 | [OK / OVER — action needed] |

---

[Brief notes from the last few sessions — what was done, what broke, what to watch for.]

**Keeping this file lean:** tag entries by the distinct line of work they
...
don't wait for this file to also cross a size threshold. Never force a
